...
# Date:
# Description:	Retrieved from the Mars simulator Help. Installs a simple exception handler at the predefined address.
#				A tiny main procedure is included that causes a trap which is 
#				caught by the handler
# Input:		No input needed
# Output:		Prints on screen "Trap Generated"
################# Code segment #####################
   .text
main:
