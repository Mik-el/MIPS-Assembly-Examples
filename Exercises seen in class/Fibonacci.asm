...
.data
fibs:.word   0 : 19         # array di interi che contiene i numeri di fibonacci
size: .word  19             # dimensione dell' array, la stessa già dichiarata
prompt: .asciiz "Quanti numeri di fibonacci genero? (2 <= x <= 19)"
.text
